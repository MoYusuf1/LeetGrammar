...
export const TOP_500_WORDS: VocabWord[] = [
  ...
  { rank: 1, somali: 'nabad', english: 'peace / hello', pos: 'noun', lessonId: 1, confidence: 'verified', sources: ['Wiktionary: nabad', 'Orwin p.24'] },
  { rank: 2, somali: 'salaan', english: 'greeting', pos: 'noun', lessonId: 1, confidence: 'single-source', sources: ['Orwin: Somali-English glossary'] },
  { rank: 3, somali: 'subax', english: 'morning', pos: 'noun', lessonId: 1, confidence: 'verified', sources: ['Wiktionary: subax', 'Orwin p.26'] },
  { rank: 4, somali: 'galab', english: 'afternoon', pos: 'noun', lessonId: 1, confidence: 'verified', sources: ['Orwin p.25', 'Wiktionary: galab'] },
  { rank: 5, somali: 'habeen', english: 'night', pos: 'noun', lessonId: 1, confidence: 'verified', sources: ['Adam 1999 s.v. "night"', 'Awde 1999 s.v. "habeen"'] },
  { rank: 6, somali: 'maalin', english: 'day', pos: 'noun', lessonId: 1, confidence: 'verified', sources: ['Orwin: Somali-English glossary', 'Adam 1999 s.v. "day"'] },
  { rank: 7, somali: 'magac', english: 'name', pos: 'noun', lessonId: 1, confidence: 'verified', sources: ['Nilsson 2023 §11.1', 'Wiktionary: magac'] },
  { rank: 8, somali: 'qof', english: 'person', pos: 'noun', lessonId: 1, confidence: 'verified', sources: ['Adam 1999 s.v. "person"', 'Awde 1999 s.v. "qof"'] },
  { rank: 9, somali: 'haa', english: 'yes', pos: 'particle', lessonId: 1, confidence: 'verified', sources: ['Adam 1999 s.v. "yes"', 'Awde 1999 s.v. "haa"'] },
  { rank: 10, somali: 'maya', english: 'no', pos: 'particle', lessonId: 1, confidence: 'verified', sources: ['Orwin p.16', 'Nilsson 2023 (attested in examples)'] },
  { rank: 11, somali: 'mahadsanid', english: 'thank you', pos: 'phrase', lessonId: 1, confidence: 'verified', sources: ['Orwin p.25', 'Wiktionary: mahadsanid'] },
  { rank: 12, somali: 'fadlan', english: 'please', pos: 'adverb', lessonId: 1, confidence: 'verified', sources: ['Farah 1992 s.v. "please"', 'Awde 1999 s.v. "fadlan"'] },
  { rank: 13, somali: 'wanaagsan', english: 'good / well', pos: 'adjective', lessonId: 1, confidence: 'verified', sources: ['Orwin: Somali-English glossary', 'Adam 1999 s.v. "good"'] },
  { rank: 14, somali: 'run', english: 'truth', pos: 'noun', lessonId: 1, confidence: 'verified', sources: ['Orwin: Somali-English glossary', 'Adam 1999 s.v. "truth"'] },
  { rank: 15, somali: 'been', english: 'lie / falsehood', pos: 'noun', lessonId: 1, confidence: 'single-source', sources: ['Wiktionary: been'] },
  { rank: 16, somali: 'cod', english: 'voice / sound', pos: 'noun', lessonId: 1, confidence: 'verified', sources: ['Adam 1999 s.v. "voice"', 'Awde 1999 s.v. "cod"'] },
  { rank: 17, somali: 'eray', english: 'word', pos: 'noun', lessonId: 1, confidence: 'verified', sources: ['Adam 1999 s.v. "word"', 'Awde 1999 s.v. "eray"'] },
  { rank: 18, somali: 'af', english: 'language / mouth', pos: 'noun', lessonId: 1, confidence: 'verified', sources: ['Adam 1999 s.v. "mouth"', 'Awde 1999 s.v. "af"'] },
  { rank: 19, somali: 'xaraf', english: 'letter (of the alphabet)', pos: 'noun', lessonId: 1, confidence: 'verified', sources: ['Nilsson 2023 §4.3', 'Farah 1992 s.v. "letter"'] },
  ...
  { rank: 25, somali: 'aabbe', english: 'father', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Nilsson 2023 §6.3', 'Wiktionary: aabbe'] },
  { rank: 26, somali: 'walaal', english: 'sibling', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Orwin: Somali-English glossary', 'Farah 1992 s.v. "brother"'] },
  { rank: 27, somali: 'ilmo', english: 'child', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Adam 1999 s.v. "child"', 'Awde 1999 s.v. "ilmo"'] },
  { rank: 28, somali: 'carruur', english: 'children', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Adam 1999 s.v. "children"', 'Awde 1999 s.v. "carruur"'] },
  { rank: 29, somali: 'dad', english: 'people', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Adam 1999 s.v. "people"', 'Awde 1999 s.v. "dad"'] },
  { rank: 30, somali: 'reer', english: 'family / household', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Orwin: Somali-English glossary', 'Farah 1992 s.v. "family"'] },
  ...
  { rank: 32, somali: 'albaab', english: 'door', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Adam 1999 s.v. "door"', 'Awde 1999 s.v. "albaab"'] },
  { rank: 33, somali: 'daaqad', english: 'window', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Nilsson 2023 (wordlist)', 'Farah 1992 s.v. "window"'] },
  { rank: 34, somali: 'miis', english: 'table', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Nilsson 2023 §6.1', 'Wiktionary: miis'] },
  { rank: 35, somali: 'kursi', english: 'chair', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Nilsson 2023 §6.1', 'Wiktionary: kursi'] },
  ...
  { rank: 37, somali: 'qalin', english: 'pen', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Farah 1992 s.v. "pen"', 'Awde 1999 s.v. "qalin"'] },
  { rank: 38, somali: 'warqad', english: 'paper / letter', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Farah 1992 s.v. "letter"', 'Awde 1999 s.v. "warqad"'] },
  { rank: 39, somali: 'sariir', english: 'bed', pos: 'noun', lessonId: 2, confidence: 'verified', sources: ['Nilsson 2023 (wordlist)', 'Adam 1999 s.v. "bed"'] },
  ...
  { rank: 40, somali: 'kan', english: 'this (m)', pos: 'pronoun', lessonId: 3, confidence: 'verified', sources: ['Nilsson 2023 §9.2', 'Orwin p.125'] },
  { rank: 41, somali: 'tan', english: 'this (f)', pos: 'pronoun', lessonId: 3, confidence: 'verified', sources: ['Nilsson 2023 §9.2', 'Orwin p.125'] },
  { rank: 42, somali: 'kaas', english: 'that (m)', pos: 'pronoun', lessonId: 3, confidence: 'verified', sources: ['Nilsson 2023 §9.2', 'Orwin p.125'] },
  { rank: 43, somali: 'taas', english: 'that (f)', pos: 'pronoun', lessonId: 3, confidence: 'verified', sources: ['Nilsson 2023 §9.2', 'Orwin p.125'] },
  { rank: 44, somali: 'kuwan', english: 'these', pos: 'pronoun', lessonId: 3, confidence: 'verified', sources: ['Nilsson 2023 §9.2', 'Orwin p.125'] },
  { rank: 45, somali: 'kuwaas', english: 'those', pos: 'pronoun', lessonId: 3, confidence: 'verified', sources: ['Nilsson 2023 §9.2', 'Orwin p.125'] },
  ...
  { rank: 47, somali: 'tuulo', english: 'village', pos: 'noun', lessonId: 3, confidence: 'verified', sources: ['Adam 1999 s.v. "village"', 'Awde 1999 s.v. "tuulo"'] },
  { rank: 48, somali: 'dal', english: 'country', pos: 'noun', lessonId: 3, confidence: 'verified', sources: ['Orwin: Somali-English glossary', 'Adam 1999 s.v. "country"'] },
  { rank: 49, somali: 'dugsi', english: 'school', pos: 'noun', lessonId: 3, confidence: 'verified', sources: ['Orwin: Somali-English glossary', 'Adam 1999 s.v. "school"'] },
  { rank: 50, somali: 'suuq', english: 'market', pos: 'noun', lessonId: 3, confidence: 'verified', sources: ['Farah 1992 s.v. "market"', 'Awde 1999 s.v. "suuq"'] },
  { rank: 51, somali: 'masjid', english: 'mosque', pos: 'noun', lessonId: 3 },
  { rank: 52, somali: 'jid', english: 'road / way', pos: 'noun', lessonId: 3, confidence: 'verified', sources: ['Orwin: Somali-English glossary', 'Adam 1999 s.v. "road"'] },
  { rank: 53, somali: 'beer', english: 'farm / garden', pos: 'noun', lessonId: 3, confidence: 'verified', sources: ['Nilsson 2023 §6.1', 'Wiktionary: beer'] },
  { rank: 54, somali: 'webi', english: 'river', pos: 'noun', lessonId: 3, confidence: 'verified', sources: ['Adam 1999 s.v. "river"', 'Awde 1999 s.v. "webi"'] },
  { rank: 55, somali: 'bad', english: 'sea', pos: 'noun', lessonId: 3, confidence: 'verified', sources: ['Orwin: Somali-English glossary', 'Adam 1999 s.v. "sea"'] },
  { rank: 56, somali: 'buur', english: 'mountain', pos: 'noun', lessonId: 3, confidence: 'verified', sources: ['Orwin: Somali-English glossary', 'Adam 1999 s.v. "mountain"'] },
  { rank: 57, somali: 'geed', english: 'tree', pos: 'noun', lessonId: 3, confidence: 'verified', sources: ['Nilsson 2023 §6.1', 'Wiktionary: geed'] },
  { rank: 58, somali: 'dab', english: 'fire', pos: 'noun', lessonId: 3, confidence: 'verified', sources: ['Adam 1999 s.v. "fire"', 'Awde 1999 s.v. "dab"'] },
  { rank: 59, somali: 'biyo', english: 'water', pos: 'noun', lessonId: 3, confidence: 'verified', sources: ['Orwin: Somali-English glossary', 'Adam 1999 s.v. "water"'] },
  ...
  { rank: 72, somali: 'kayga', english: 'my / mine (m)', pos: 'pronoun', lessonId: 4, confidence: 'verified', sources: ['Nilsson 2023 §9.3', 'Orwin p.134'] },
  { rank: 73, somali: 'kaaga', english: 'your (m)', pos: 'pronoun', lessonId: 4, confidence: 'verified', sources: ['Nilsson 2023 §9.3', 'Orwin p.134'] },
  { rank: 74, somali: 'kiisa', english: 'his', pos: 'pronoun', lessonId: 4, confidence: 'verified', sources: ['Nilsson 2023 §9.3', 'Orwin p.134'] },
  { rank: 75, somali: 'keeda', english: 'her / hers', pos: 'pronoun', lessonId: 4, confidence: 'verified', sources: ['Nilsson 2023 §9.3', 'Orwin p.134'] },
  { rank: 76, somali: 'keenna', english: 'our (m) — the inclusive our, including you', pos: 'pronoun', lessonId: 4, confidence: 'verified', sources: ['Nilsson 2023 §9.3', 'Orwin p.134'] },
  { rank: 77, somali: 'kooda', english: 'their', pos: 'pronoun', lessonId: 4, confidence: 'verified', sources: ['Nilsson 2023 §9.3', 'Orwin p.134'] },
  { rank: 78, somali: 'kee', english: 'which one', pos: 'pronoun', lessonId: 4, confidence: 'verified', sources: ['Nilsson 2023 §9.4', 'Orwin p.216'] },
