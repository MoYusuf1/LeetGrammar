...
export const TOP_500_WORDS: VocabWord[] = [
  ...
  { rank: 11, somali: 'mahadsanid', english: 'thank you', pos: 'phrase', lessonId: 1, confidence: 'single-source', sources: ['Orwin: Somali-English glossary'] },
  ...
  { rank: 19, somali: 'xarf', english: 'letter (of alphabet)', pos: 'noun', lessonId: 1, confidence: 'single-source', sources: ['Nilsson 2023 (wordlist)'] },
