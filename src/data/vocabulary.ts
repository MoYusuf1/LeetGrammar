...
export const TOP_500_WORDS: VocabWord[] = [
  ...
  { rank: 40, somali: 'kan', english: 'this (m)', pos: 'pronoun', lessonId: 3, confidence: 'single-source', sources: ['Orwin: Somali-English glossary'] },
  ...
  { rank: 72, somali: 'kayga', english: 'my / mine (m)', pos: 'pronoun', lessonId: 4, confidence: 'single-source', sources: ['Nilsson 2023 (wordlist)'] },
  ...
  { rank: 76, somali: 'keenna', english: 'our (m)', pos: 'pronoun', lessonId: 4, confidence: 'single-source', sources: ['Nilsson 2023 (wordlist)'] },
  { rank: 77, somali: 'kooda', english: 'their', pos: 'pronoun', lessonId: 4, confidence: 'single-source', sources: ['Nilsson 2023 (wordlist)'] },
