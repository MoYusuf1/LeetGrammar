...
export const COURSE_OUTCOMES: CourseOutcome[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      { mode: 'unseen-reading', lessonIds: [5, 8], evidenceIds: ['l5-gist-b', 'l8-gist-b'], implemented: true, note: 'New context prevents specimen recall.' },
    ],
  },
  {
    ...
    evidence: [
      ...
      { mode: 'unseen-reading', lessonIds: [5, 8], evidenceIds: ['l5-gist-b', 'l8-gist-b'], implemented: true, note: 'Later vertical-slice transfer questions ask for the decisive clue in new configurations.' },
    ],
  },
];
